...
/*
    run the following command for generating wasm module

    emcc matrix.c -o matrix.js -sEXPORTED_FUNCTIONS="['_run_matrix_multiplication']" -sEXPORTED_RUNTIME_METHODS="['cwrap']" -sALLOW_MEMORY_GROWTH=1 -O3
    
    next task is to open browser and running the index file which links the matrix.js file.
 */
