...
C_FILES=("bubble_sort_wasm.c" "fibonacci_wasm.c" "hanoi_wasm.c" "hanoi_wasm.c" "prime_seive_wasm.c" "qsort_wasm.c")
JS_FILES=("bubble_sort.js" "fibonacci.js" "hanoi.js" "matrix.js" "prime.js" "qsort.js")
FUNCTION_NAMES=("_run_bubble_sort" "_run_fibonacci" "_run_hanoi" "_run_matrix" "_run_prime" "_run_qsort")
...
INPUT_SIZES["hanoi_sizes"]="[10, 15, 20, 22, 24, 25]"
INPUT_SIZES["matrix_sizes"]="[100, 200, 300, 400, 500]"
INPUT_SIZES["qsort_sizes"]="[1000, 5000, 10000, 50000, 100000]"
INPUT_SIZES["sieve_limits"]="[100000, 500000, 1000000, 5000000]"
...
str="const benchmarks = [
    ...
    { file: 'matrix.js', func: 'run_matrix', sizes: [100, 200, 300, 400, 500] },
    { file: 'prime.js', func: 'run_prime', sizes: [100000, 500000, 1000000, 5000000] },
